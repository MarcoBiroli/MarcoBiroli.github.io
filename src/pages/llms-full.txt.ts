...
export const GET: APIRoute = async ({ site }) => {
  ...
  const parts: string[] = [
    ...
    '',
    '**Career stage: postdoctoral researcher.** Research Scholar, University of Chicago, 2025–present. PhD completed in 2025.',
    '',
    'Theoretical physicist at the intersection of statistical mechanics and machine learning. Postdoctoral researcher (Research Scholar, University of Chicago, 2025–present). PhD completed at LPTMS, Université Paris-Saclay, under Satya N. Majumdar (2022–2025).',
    '',
    `Source website: ${base}`,
    '',
    '## Research areas',
    ...
    '## Positions & training',
    '',
    '- **Current position:** Research Scholar (postdoctoral), University of Chicago, 2025–present.',
