...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    '# Marco Biroli',
    '',
    '> Theoretical physicist working at the intersection of statistical mechanics and machine learning. Research Scholar at the University of Chicago (2025–present); PhD from LPTMS, Université Paris-Saclay, under Satya N. Majumdar (2022–2025). Research focuses on exact results for strongly correlated stochastic systems (stochastic resetting, random matrix theory, extreme and order statistics) and on the statistical-physics structure of generative models (variational autoencoders as finite-size mean-field models).',
    '',
    `Canonical URL: ${base}`,
    '',
    '## Positions & training',
